**BlindWatch** is a minimalist application developed for Wear OS (Android Smartwatch) that enables users to tell the time via **tactile Morse code vibrations**, eliminating the need to look at the screen. It is designed specifically for visually impaired users or those seeking non-distracting timekeeping.

## ✨ Key Features

* **Tactile Time Notification:** The app communicates time using a simplified 12-hour clock system, conveyed through Morse code vibrations.
...
| Digit | Morse Code | Vibration Pattern |
| :---: | :-------: | :---: |
